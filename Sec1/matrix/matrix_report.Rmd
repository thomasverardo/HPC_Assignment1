...
I produce two different plots: one that represent the time to compute the matrix-matrix sum for different shapes and one with the same shape but with different mapping.
...
ggplot(data=data_1200, mapping = aes(x = n_process, y=time)) +
    ...
    scale_colour_manual("", 
                      breaks = c("3D", "2D", "1D"),
                      values = c("3D" = "blue","2D" = "purple", "1D" = "red")
                      ) 
